...
export const personaJuridicaValidationSchema = yup.object({
    ...
    datosFiscales: yup.object().shape({
        ...
        tipoResponsableGanancias: yup.string().required("Este campo es requerido."),
        codigosActividades: yup.array().of(
    ...
    actividadOrganizacion: yup.array().of(
        yup.object().shape({
            actividad: yup.string().required("Este campo es requerido."),
        })
    ).required("Este campo es requerido."),
    declaracionesPI: yup.object().shape({
        inscripcionSujetoObligado: yup.bool().required("Este campo es requerido.")
    })
})